...
The picture below depicts an approach for using Azure packaged servcies as modules to enable the Lambda architecture on the Iot Edge and add intelligence as preprocessing to Azure IoT Central.
